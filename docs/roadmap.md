...
| Forms/tables | RHF+Zod / TanStack Table | **Keep — installed** | Choice fixed (tech-stack.md + frontend.md); both are now dependencies in use (invoice/contact/product forms; list tables). |
