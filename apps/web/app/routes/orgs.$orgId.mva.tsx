 ...
 * `feat-altinn-mva-submission` and is not offered here. The MVA-status fork decides whether a melding
...
export default function MvaMeldingRoute({ loaderData }: Route.ComponentProps) {
  ...
  return (
    <main className="mx-auto grid max-w-3xl gap-6 p-6 sm:p-10">
      ...
      {!loaderData.registered ? (
        ...
        <MeldingView orgId={orgId} year={year} data={loaderData} />
      )}
