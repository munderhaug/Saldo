...
export default [
  ...
  route('orgs/:orgId/purchases', 'routes/orgs.$orgId.purchases.tsx'),
  route('orgs/:orgId/purchases/new', 'routes/orgs.$orgId.purchases.new.tsx'),
  route('orgs/:orgId/purchases/:purchaseId', 'routes/orgs.$orgId.purchases.$purchaseId.tsx'),
  route('orgs/:orgId/owner/new', 'routes/orgs.$orgId.owner.new.tsx'),
