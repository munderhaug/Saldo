...
- **Surgical changes.** Touch only what the task requires. No drive-by refactoring; match the surrounding
  style. Every changed line should trace to the requirement. Before adding a new route/module, pick 1–2
  existing high-quality siblings in the same package and mirror their structure, naming, error-handling,
  and test style.
