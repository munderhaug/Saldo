...
- **SQL integrity surface** (13 migrations in `db/migrations/*.sql`): 18 tables, 21 RLS policies, 7 triggers, 14 functions. Integrity triggers: bank_transaction_append_only, invoice_immutable, invoice_line_immutable, posting_immutable, posting_period_lock, voucher_immutable, voucher_period_lock.
<!-- /AUTOGEN:arch-graph -->
